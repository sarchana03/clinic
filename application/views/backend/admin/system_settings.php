		...
		<div class="panel panel-info">
			...
			<h1>
				...
				<div class="form-group">
					...
					?>
					<input type="text" class="form-control" name="school_id" readonly value="<?php  echo ($this->db->get_where('settings', array('type' => 'school_id'))->row()->description)?$this->db->get_where('settings', array('type' => 'school_id'))->row()->description:$this->session->userdata('school_id');?>"> 
					 <!--<input type="text" class="form-control" name="system_name" value="<?php  //echo ($this->db->get_where('settings', array('type' => 'school_id'))->row()->description)?$this->db->get_where('settings', array('type' => 'school_id'))->row()->description:$this->session->userdata('school_id');?>"> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="text" class="form-control" name="system_title" value=" <?php echo $this->db->get_where('school', array('school_id' => $this->session->userdata('school_id')))->row()->school_name;?>">
					</div>
				</div>
