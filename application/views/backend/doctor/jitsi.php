				        ...
				        <div class="panel panel-info">
				            ...
				            <div class="panel-wrapper collapse out" aria-expanded="true">
				                <div class="panel-body">
				                    ...
				                    <?php echo form_open(base_url() . 'doctor/jitsi/add/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				                    <div class="row">
				                        <div class="col-sm-6">
				        ...
				        <div class="panel panel-info">
							...
							<td><?=$this->crud_model->get_type_name_by_id('section', $row['section_id']);?></td> -->
				                            ...
				                            <td>
				                                ...
				                                <a
				                                    href="<?php echo base_url();?>doctor/stream_jitsi/<?php echo $row['jitsi_id'];?>"><button
				                                        type="button" class="btn btn-success btn-rounded btn-sm"><i
				                                            class="fa fa-youtube-play"></i> start meeting</button></a>
				                                <?php endif;?>

				                                <a href="#"
				                                    onclick="confirm_modal('<?php echo base_url();?>doctor/jitsi/delete/<?php echo $row['jitsi_id'];?>');"><button
