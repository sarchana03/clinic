            ...
            <div class="row">
                    ...
                    <tbody>
					 ...
					 <?php $select = $this->live_class_model->selectJitsiStudentByClassSection();
                        ...
                        <tr>
							...
							<a href="<?php echo base_url();?>student/stream_jitsi/<?php echo $row['jitsi_id'];?>"><button type="button" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-youtube-play"></i> Join Class</button></a>
							<?php endif;?>
